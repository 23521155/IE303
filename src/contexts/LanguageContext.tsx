...
const translations: Translations = {
  ...
  heroDesc: {
    vi: 'Nền tảng thi thử trực tuyến cung cấp các đề thi chuẩn xác, giao diện hiện đại giúp bạn làm quen và tự tin đạt điểm cao trong kỳ thi thực tế.',
    en: 'Online mock exam platform providing accurate tests and modern interface to help you get familiar and confidently achieve high scores in real exams.',
    ja: '正確なテストと最新のインターフェースを提供するオンライン模擬試験プラットフォーム。実際の試験で高得点を獲得する自信をつけます。'
  },
  ...
  featuredDesc: { vi: 'Các đề thi chứng chỉ phổ biến nhất được hàng nghìn học viên lựa chọn để ôn luyện mỗi ngày.', en: 'The most popular certification exams chosen by thousands of students for daily practice.', ja: '毎日何千人もの学生に選ばれている最も人気のある資格試験。' },
  ...
  whyDesc: { vi: 'Nền tảng được thiết kế tối ưu giúp bạn đạt điểm số cao nhất.', en: 'Platform optimized to help you achieve the highest score.', ja: '最高得点を達成するために最適化されたプラットフォーム。' },
  readyForExam: { vi: 'Bạn đã sẵn sàng cho kỳ thi?', en: 'Ready for the exam?', ja: '試験の準備はできましたか？' },
  readyDesc: { vi: 'Đăng ký tài khoản miễn phí để lưu kết quả, theo dõi tiến độ học tập và mở khóa thêm nhiều đề thi chất lượng cao.', en: 'Register a free account to save results, track learning progress, and unlock more high-quality exams.', ja: '無料アカウントを登録して、結果を保存し、学習の進捗を追跡し、さらに高品質な試験をアンロックしましょう。' },
  ...
  feat1Desc: { vi: 'Ngân hàng câu hỏi khổng lồ, được cập nhật liên tục bám sát cấu trúc đề thi mới nhất của các tổ chức giáo dục.', en: 'A massive question bank, continuously updated closely following the latest exam structure of educational organizations.', ja: '教育機関の最新の試験構成に沿って継続的に更新される膨大な問題バンク。' },
  feat2Title: { vi: 'Đa dạng chứng chỉ', en: 'Diverse Certificates', ja: '多様な資格' },
  feat2Desc: { vi: 'Từ ngoại ngữ (IELTS, TOEIC), chứng chỉ IT (AWS, Cisco) đến các chứng chỉ chuyên ngành kế toán, tài chính.', en: 'From foreign languages (IELTS, TOEIC), IT certificates (AWS, Cisco) to specialized accounting and finance certificates.', ja: '外国語（IELTS、TOEIC）、IT資格（AWS、Cisco）から会計、財務の専門資格まで。' },
  feat3Title: { vi: 'Giao diện thông minh', en: 'Smart Interface', ja: 'スマートなインターフェース' },
  feat3Desc: { vi: 'Môi trường thi thử giả lập 99% thực tế, đếm ngược thời gian, chấm điểm tự động và phân tích kết quả chi tiết.', en: '99% realistic mock exam environment, countdown timer, automatic scoring, and detailed result analysis.', ja: '99％リアルな模擬試験環境、カウントダウンタイマー、自動採点、詳細な結果分析。' },
  
  // Footer
  footerDesc: {
    vi: 'Nền tảng luyện thi trực tuyến hàng đầu với kho đề thi đa dạng, chất lượng cao giúp bạn đạt kết quả tốt nhất trong các kỳ thi chứng chỉ quốc tế.',
    en: 'The leading online exam preparation platform with a diverse, high-quality exam bank to help you achieve the best results in international certification exams.',
    ja: '国際資格試験で最高の結果を達成するのに役立つ、多様で高品質な試験バンクを備えた主要なオンライン試験対策プラットフォーム。'
  },
  allRightsReserved: {
  ...
  examLibDesc: { vi: 'Hơn 500+ đề thi chứng chỉ quốc tế được cập nhật thường xuyên từ các nguồn uy tín.', en: 'Over 500+ international certification exams regularly updated from reputable sources.', ja: '信頼できるソースから定期的に更新される500以上の国際認定試験。' },
  searchExams: { vi: 'Tìm kiếm đề thi, chứng chỉ...', en: 'Search exams, certificates...', ja: '試験、資格を検索...' },
  ...
  noResultsDesc: { vi: 'Không có đề thi nào phù hợp với từ khóa', en: 'No exams match the keyword', ja: 'キーワードに一致する試験はありません' },
  ...
  examNotFoundDesc: { vi: 'Đề thi bạn yêu cầu không tồn tại hoặc đã bị xóa.', en: 'The requested exam does not exist or has been deleted.', ja: 'リクエストされた試験は存在しないか、削除されました。' },
  ...
  notice1: { vi: 'Hãy chuẩn bị môi trường yên tĩnh, đảm bảo kết nối internet ổn định để không làm gián đoạn bài làm.', en: 'Please prepare a quiet environment, ensure stable internet connection to not interrupt the exam.', ja: '静かな環境を準備し、安定したインターネット接続を確保して、試験が中断されないようにしてください。' },
  notice2: { vi: 'Khi ấn nút "Bắt đầu thi", thời gian sẽ lập tức đếm ngược và không thể tạm dừng.', en: 'When clicking "Start Exam", the time will immediately count down and cannot be paused.', ja: '「試験開始」ボタンを押すと、時間はすぐにカウントダウンを開始し、一時停止することはできません。' },
  notice3: { vi: 'Bài thi sẽ tự động nộp khi hết thời gian quy định hoặc khi bạn chọn nút nộp bài.', en: 'The exam will automatically submit when the time is up or when you click the submit button.', ja: '制限時間が終了するか、提出ボタンをクリックすると、試験は自動的に提出されます。' },
  startDoingExam: { vi: 'Bắt đầu làm bài', en: 'Start Exam', ja: '試験を開始' },
  introDesc: { vi: 'Đề thi được biên soạn kỹ lưỡng bởi đội ngũ chuyên gia, mô phỏng hoàn toàn cấu trúc, độ khó và thời gian của kỳ thi thật. Hoàn thành bài thi giúp bạn đánh giá năng lực hiện tại, làm quen với áp lực phòng thi và tối ưu hóa điểm số.', en: 'The exam is carefully compiled by a team of experts, completely simulating the structure, difficulty and time of the real exam. Completing the exam helps you evaluate your current ability, get used to the pressure of the exam room and optimize your score.', ja: '試験は専門家チームによって慎重に編集され、実際の試験の構造、難易度、時間を完全にシミュレートしています。試験を完了すると、現在の能力を評価し、試験室のプレッシャーに慣れ、スコアを最適化するのに役立ちます。' },
  question: { vi: 'Câu', en: 'Question', ja: '質問' },
  submitExam: { vi: 'Nộp bài', en: 'Submit', ja: '提出' },
  submitting: { vi: 'Đang nộp...', en: 'Submitting...', ja: '提出中...' },
  confirmSubmit: { vi: 'Bạn có chắc chắn muốn nộp bài ngay bây giờ?', en: 'Are you sure you want to submit now?', ja: '今すぐ提出してもよろしいですか？' },
  ...
  materialsDesc: { vi: 'Khám phá kho tài liệu phong phú giúp bạn đạt điểm cao.', en: 'Explore a rich repository of materials to help you score high.', ja: '高得点に役立つ豊富な資料を探索してください。' },
  ...
  noMaterialsFound: { vi: 'Không tìm thấy tài liệu phù hợp.', en: 'No matching materials found.', ja: '一致する資料は見つかりませんでした。' },

  // Flashcards
  flashcardLib: { vi: 'Kho Flashcard Ôn Tập', en: 'Flashcard Library', ja: 'フラッシュカードライブラリ' },
  flashcardDesc: { vi: 'Ghi nhớ từ vựng và khái niệm IT Passport, FE và Tiếng Nhật dễ dàng hơn với phương pháp lặp lại ngắt quãng (Spaced Repetition).', en: 'Memorize IT Passport, FE and Japanese vocabulary and concepts more easily with Spaced Repetition method.', ja: '間隔反復（Spaced Repetition）法を使用して、ITパスポート、FE、日本語の語彙と概念をより簡単に記憶します。' },
  ...
  noSavedMaterialsDesc: { vi: 'Bạn chưa lưu tài liệu học tập nào vào danh sách.', en: "You haven't saved any study materials to your list.", ja: 'リストに学習資料を保存していません。' },
  exploreMaterials: { vi: 'Khám phá tài liệu', en: 'Explore Materials', ja: '資料を探索する' },

  // Auth (Login / Register)
  welcomeBack: { vi: 'Chào mừng bạn quay lại hệ thống thi thử', en: 'Welcome back to the exam platform', ja: '試験システムへお帰りなさい' },
  ...
  joinNow: { vi: 'Tham gia ngay để bắt đầu luyện thi', en: 'Join now to start practicing', ja: '今すぐ参加して練習を始めましょう' },
  ...
  alreadyHaveAccount: { vi: 'Đã có tài khoản?', en: 'Already have an account?', ja: 'すでにアカウントをお持ちですか？' },
  backToLogin: { vi: 'Về đăng nhập', en: 'Back to login', ja: 'ログインに戻る' },
  passwordMismatch: { vi: 'Mật khẩu xác nhận không khớp!', en: 'Passwords do not match!', ja: 'パスワードが一致しません！' },
