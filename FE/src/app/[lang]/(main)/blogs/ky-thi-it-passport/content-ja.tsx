            ...
            <header className="relative bg-background pt-12 pb-8 border-b border-border/50 overflow-hidden" style={{ backgroundImage: 'radial-gradient(ellipse 70% 55% at 50% 0%, rgba(232, 121, 33, 0.09) 0%, transparent 65%)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
                        ...
                        <a href="/category" className="hover:text-primary transition-colors">ブログ</a>
                        <ChevronRight className="w-4 h-4" />
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 py-4">
                        ...
                        <div className="flex items-center gap-4 text-sm font-medium text-muted-foreground">
                            ...
                            <div className="flex items-center gap-2 pl-4 border-l border-border/60">
                                <button className="p-2 rounded-full hover:bg-muted/60 transition-colors" title="共有">
                                    <Share2 className="w-4 h-4" />
                                </button>
                                <button className="p-2 rounded-full hover:bg-muted/60 transition-colors" title="保存">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
                    <div className="bg-muted/30 border border-border/60 rounded-md p-6 text-center hover:shadow-md transition-shadow">
                        <h4 className="font-bold text-primary mb-2">営業・マーケティング担当者</h4>
                        <p className="text-sm text-muted-foreground">
                            テクノロジークライアントと協力し、より良いコンサルティングのためにIT製品を理解する必要がある方。
                        </p>
                    </div>
                    <div className="bg-muted/30 border border-border/60 rounded-md p-6 text-center hover:shadow-md transition-shadow">
                        <h4 className="font-bold text-primary mb-2">ITコムター（IT通訳・翻訳者）</h4>
                        <p className="text-sm text-muted-foreground">
                            正確かつ専門的に翻訳するための語彙力とITの基礎知識が必要な方。
                        </p>
                    </div>
                    <div className="bg-muted/30 border border-border/60 rounded-md p-6 text-center hover:shadow-md transition-shadow">
                        <h4 className="font-bold text-primary mb-2">バックオフィス・人事（HR）</h4>
                        <p className="text-sm text-muted-foreground">
                            IT企業で働いているがエンジニアではなく、同僚の「言語」を理解したい方。
                        </p>
                    </div>
                    <div className="bg-muted/30 border border-border/60 rounded-md p-6 text-center hover:shadow-md transition-shadow">
                        <h4 className="font-bold text-primary mb-2">異業種への転職を目指す学生</h4>
                        <p className="text-sm text-muted-foreground">
