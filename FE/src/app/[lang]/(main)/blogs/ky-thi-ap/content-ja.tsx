            ...
            <header className="relative bg-background pt-12 pb-8 border-b border-border/50 overflow-hidden" style={{ backgroundImage: 'radial-gradient(ellipse 70% 55% at 50% 0%, rgba(232, 121, 33, 0.09) 0%, transparent 65%)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
                        <a href="/ja" className="hover:text-primary transition-colors">ホーム</a>
                        <ChevronRight className="w-4 h-4" />
                        <a href="/ja/category" className="hover:text-primary transition-colors">ブログ</a>
                        <ChevronRight className="w-4 h-4" />
                            ...
                            <div className="mt-16 pt-8 border-t border-border/40">
                                <div className="flex items-center gap-3 flex-wrap">
                                    ...
                                    {postDetail.tags.map((tag) => (
                                        <a key={tag} href={`/ja/tag/${tag}`} className="px-3 py-1.5 bg-muted/50 border border-border/40 text-foreground/70 text-sm rounded-md hover:bg-muted hover:text-foreground transition-colors font-medium">
                                            #{tag}
                                        </a>
                                    ))}
                                </div>
