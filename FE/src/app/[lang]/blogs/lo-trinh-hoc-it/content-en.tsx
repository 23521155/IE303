        ...
        <main className="min-h-screen bg-background transition-colors duration-300">
                    ...
                    <article className="lg:col-span-9 bg-background rounded-2xl border border-border/60 overflow-hidden">
                        <figure className="w-full bg-muted/[0.2] p-4">
                            ...
                            <figcaption className="text-center text-sm text-muted-foreground/60 mt-3 italic">
                                Japan&apos;s national IT certification roadmap (IPA) — from Level 1 (IT Passport) to Level 4 (Specialist). Source: <a href="https://www.ipa.go.jp/shiken/about/about.html" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">IPA</a>
                            </figcaption>
                        </figure>
                        ...
                        <div className="p-6 sm:p-10 text-lg leading-relaxed text-foreground/80">
                            ...
                            <p className="mb-4">
                                <strong><a href="/en/exams" className="text-primary hover:underline">IT Passport</a></strong> is the most basic certification. Contrary to popular belief, it is designed for <strong>all workers</strong> in the digital age, not just IT professionals.
                            </p>
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3">
                                    <Target className="w-6 h-6 text-indigo-500 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-semibold text-secondary dark:text-foreground">Target Audience</h4>
                                        <p className="text-base text-muted-foreground">New graduates, business staff (Sales, HR, Marketing) at IT companies, or career-changers who want a broad overview of technology and business management.</p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-green-500 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-semibold text-secondary dark:text-foreground">Key Knowledge Areas</h4>
                            ...
                            <div className="bg-muted/[0.15] border-l-4 border-blue-500 p-5 rounded-r-xl mb-8">
                                ...
                                <p className="text-base">The exam runs year-round as a CBT. No coding required — just memorize key terms and practice past papers on the <a href="/en/exams" className="text-primary hover:underline">IT Shiken practice system</a>. You can pass within 1–2 months of focused study.</p>
                            </div>
                            ...
                            <p className="mb-4">
                                This is the official milestone proving you are a <strong>real IT engineer</strong>. It splits into two popular tracks: <strong><a href="https://www.ipa.go.jp/shiken/kubun/fe.html" target="_blank" rel="noopener noreferrer" className="text-green-600 dark:text-green-400 hover:underline">FE (Fundamental IT Engineer)</a></strong> for software developers and <strong><a href="https://www.ipa.go.jp/shiken/kubun/sg.html" target="_blank" rel="noopener noreferrer" className="text-green-600 dark:text-green-400 hover:underline">SG (Information Security Management)</a></strong> for system administrators.
                            </p>
                            <div className="space-y-4 mb-6">
                                <div className="flex gap-3">
                                    <CheckCircle2 className="w-6 h-6 text-green-500 shrink-0 mt-1" />
                                    <div>
                                        <h4 className="font-semibold text-secondary dark:text-foreground">FE Exam Structure (Unique Format):</h4>
                                        <ul className="list-disc pl-5 mt-1 text-base text-muted-foreground">
                            ...
                            <p className="mb-4">
                                <strong><a href="https://www.ipa.go.jp/shiken/kubun/ap.html" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">AP (Applied Information Technology Engineer)</a></strong> is the gold standard for Senior Engineers, Team Leads, and BrSEs. Holding this certification grants <strong>significant bonus points</strong> for Permanent Residency or the HSP visa.
                            </p>
                            <div className="grid sm:grid-cols-2 gap-6 mb-8">
                                <div className="border border-border/60 p-5 rounded-xl">
                                    <h4 className="font-bold text-secondary dark:text-foreground mb-2 text-base border-b pb-2 border-border/50">Morning (Multiple Choice)</h4>
                                    <p className="text-sm text-muted-foreground">80 questions / 150 min. Requires 60% to pass. Covers a very wide range from microprocessors, computer architecture, encryption algorithms to 3rd/4th normal form database design.</p>
                                </div>
                                <div className="border border-border/60 p-5 rounded-xl">
                                    <h4 className="font-bold text-secondary dark:text-foreground mb-2 text-base border-b pb-2 border-border/50">Afternoon (Short Answer / Case Study)</h4>
                                    <p className="text-sm text-muted-foreground">150 min. Solve 1 mandatory question (Security) and <strong>choose 4 of 10</strong> specialty topics (Programming, DB, Network, Embedded, Audit...). Requires reading 4–5 page A4 system scenarios and writing short answers.</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-base mb-8">
                                ...
                                <div className="p-3 border border-border/60 rounded-xl bg-muted/[0.15]"><strong className="text-purple-600 dark:text-purple-400"><a href="https://www.ipa.go.jp/shiken/kubun/sa.html" target="_blank" rel="noopener noreferrer" className="hover:underline">SA (System Architect)</a>:</strong> Holistic solution design engineer.</div>
                                <div className="p-3 border border-border/60 rounded-xl bg-muted/[0.15] sm:col-span-2"><strong className="text-purple-600 dark:text-purple-400"><a href="https://www.ipa.go.jp/shiken/kubun/sc.html" target="_blank" rel="noopener noreferrer" className="hover:underline">SC (Security Specialist)</a>:</strong> National qualification for information security practice.</div>
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div className="bg-gradient-to-br from-secondary/60 to-secondary dark:to-secondary/80 rounded-2xl p-8 sm:p-10 text-center shadow-lg">
                    ...
                    <p className="text-white/80 mb-8 max-w-2xl mx-auto">IT Shiken provides free practice exams, realistic questions, automatic grading and detailed analysis. Start today — no registration needed!</p>
