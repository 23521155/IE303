...
export const metadata: Metadata = {
    ...
    description: 'Tìm hiểu IT Passport: khái niệm, cấu trúc đề thi, so sánh, cách đăng ký, lộ trình ôn luyện chi tiết.',
    keywords: ['IT Passport', 'iPass', 'chứng chỉ IT Nhật', 'IT Shiken'],
    openGraph: {
        title: postDetail.title,
        description:
            'Tìm hiểu IT Passport: khái niệm, cấu trúc đề thi, so sánh, cách đăng ký, lộ trình ôn luyện chi tiết.',
        ...
        <main className="min-h-screen bg-white dark:bg-[#121212] py-8 transition-colors duration-300 text-slate-900 dark:text-slate-200">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
                <Image
                    ...
                    alt="IT Passport là gì - chứng chỉ công nghệ thông tin Nhật Bản"
                    width={500}
                    height={500}
