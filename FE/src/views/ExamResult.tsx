    ...
    return (
        <div className="bg-slate-50 dark:bg-[#121212] min-h-screen py-10 transition-colors duration-300">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    id="review-section"
                    className="bg-white dark:bg-[#1a1a1a] rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden transition-colors duration-300"
                >
                            ...
                            >
                                ...
                                <div className="space-y-3 pl-11">
                                    {q.options.map((option: string, optIndex: number) => {
                                        ...
                                        if (isCorrectOption) {
                                            bgClass =
                                                'bg-green-50 dark:bg-green-900/20 border-green-500 dark:border-green-600/50';
                                            textClass = 'text-green-800 dark:text-green-400 font-medium';
                                            icon = (
                                                <CheckCircle2 className="h-5 w-5 text-green-500 dark:text-green-400 ml-auto" />
                                            );
                                            ...
                                            icon = (
                                                <XCircle className="h-5 w-5 text-red-500 dark:text-red-400 ml-auto" />
                                            );
                                        }
                                        ...
                                        return (
                                            <div
                                                key={optIndex}
                                                className={`p-4 rounded-xl border flex items-center gap-3 transition-colors ${bgClass}`}
                                            >
                                                <div
